...
function Landing() {
  return (
    <main className='w-full h-screen bg-(--bg-primary)'>
        ...
        <Link to={'/signup'} className='px-6 py-2 bg-(--btn-secondary-bg) rounded-full text-(--btn-secondary-text) text-lg font-semibold hover:bg-(--btn-secondary-hover) cursor-pointer'>Get Started</Link>
        </div>
    </main>
  )
}
